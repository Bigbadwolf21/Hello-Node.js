...
http.createServer(function (request, response) {
    ...
    // Send response body
    response.end(`Hello World!\n Guess who is new to Backend development with Node.js\n Me! ${firstName} ${lastName} I am ${age}years old, I am currently studying ${course} at ${school}\n I am currently building skills in ${doingAtAsuuStrikeFest} at ${where}.\n I am interested in ${interests}, and I am currently open to mentorship and internships in ${roles} roles.`);
